...
ylabel({'(F-F0)/F0'},'FontSize',12);
    ...
    %rectangle('Position', [Pr_data{1, i}.b{1, 1}.bt(1), -2*Pr_data{1, i}.b{1, 1}.av_sigma_delGp, Pr_data{1, i}.b{1, 1}.bt(end), 4*Pr_data{1, i}.b{1, 1}.av_sigma_DeltaG], 'FaceColor', [1 0.8 0.8], 'EdgeColor', 'none');
    
    p=length(Pr_data{1, i}.b);
    for n=1:p;
              plot(Pr_data{1, i}.b{1, n}.delt,Pr_data{1, i}.b{1, n}.delGp, 'Color', colorstring(n),'LineWidth',2);
...
ylabel({'(F-F0)/F0'},'FontSize',11);
   % ylim([-0.6 yl2])
    ...
    %rectangle('Position', [Pr_data{1, l}.b{1, 1}.bt(1), -2*Pr_data{1, l}.b{1, 1}.av_sigma_delGp, Pr_data{1, l}.b{1, 1}.bt(end), 4*Pr_data{1, l}.b{1, 1}.av_sigma_DeltaG], 'FaceColor', [1 0.8 0.8], 'EdgeColor', 'none');
    p=length(Pr_data{1, l}.b);
    for n=1:p;
             plot(Pr_data{1, l}.b{1, n}.delt, Pr_data{1, l}.b{1, n}.delGp, 'Color', colorstring(n),'LineWidth',2);
             %plot(b{1, 1}.bt,b{1, n}.bRp, 'r','LineWidth',2);
    end
end
...
for i=1:l;
    ...
    annotation('textbox', txt_title,'String',{'dF/F block'},'FontSize',10,'LineStyle','none');%'Color',[2 0 0]);
