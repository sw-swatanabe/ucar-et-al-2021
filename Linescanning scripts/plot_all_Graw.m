...
%plotbrowser('on');
hold on
title({'dF/F0'},'FontSize',10);
%xl1=0; xl2=140;
%xl1=150; xl2=250;
xl1=0; xl2=length(Pr_data{1, 1}.b{1, 1}.Graw);
%yl2=1;
...
ylabel({'(F-F0)/F0'},'FontSize',12);
   ...
   % rectangle('Position', [Pr_data{1, i}.b{1, 1}.bt(1), -2*Pr_data{1, i}.b{1, 1}.av_sigma_bGp, Pr_data{1, i}.b{1, 1}.bt(end), 4*Pr_data{1, i}.b{1, 1}.av_sigma_bGp], 'FaceColor', [1 0.8 0.8], 'EdgeColor', 'none');
    ...
    for n=1:p;
              plot(Pr_data{1, i}.b{1, n}.t, Pr_data{1, i}.b{1, n}.Graw,  colorstring(n),'LineWidth',2);
...
ylabel({'(F-F0)/F0'},'FontSize',10);
    ...
    for n=1:p;
             plot(Pr_data{1, l}.b{1, n}.t,Pr_data{1, l}.b{1, n}.Graw, colorstring(n),'LineWidth',2);
             %plot(b{1, 1}.bt,b{1, n}.bRp, 'r','LineWidth',2);
    end
