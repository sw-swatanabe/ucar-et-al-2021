...
xl1=80; xl2=150;
%xl1=150; xl2=250;
xl1=0; xl2=length(Pr_data{1, 1}.b{1, 1}.DeltaGp);
yl2=1;
...
ylabel({'(F-F0)/F0 '},'FontSize',12);
    ...
    for n=1:p;
              plot(Pr_data{1, 1}.b{1, 1}.t,Pr_data{1, i}.b{1, n}.DeltaGp,  colorstring(n),'LineWidth',2);
...
ylabel({'(F-F0)/F0'},'FontSize',11);
    ...
    for n=1:p;
             plot(Pr_data{1, l}.b{1, n}.t,Pr_data{1, l}.b{1, n}.DeltaGp,  colorstring(n),'LineWidth',2);
             %plot(b{1, 1}.bt,b{1, n}.bRp, 'r','LineWidth',2);
    end
end
...
for i=1:l;
    ...
    annotation('textbox', txt_title,'String',{'dF/F raw'},'FontSize',10,'LineStyle','none');%'Color',[2 0 0]);
